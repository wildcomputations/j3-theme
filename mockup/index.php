...
<div class="main twoColumn">
    <div class="rightColumn">
        <article class="visualPage">
            <p>This website serves to
    connect us with our friends and family, to inspire others to go on their own adventures, and as a reference for ourselves.
    </p>
    <p>
    Our adventures include skiing, hiking, kayaking, and flying.
    We do something fun almost every weekend and post a report. We have also posted more details on some of our favorite trips.
    </p>
    <p>
    We also have information on our solar home and its latest status.
            </p>
        </article>
    </div>
    ...
    <div class="rightColumn">
        ...
        <div class="albumSummary">
            <div class="stackPhoto">
                <a href="#" class="photoLink"><img width="160" height="160" src="P_Vega_de_Calardos_(160x160).jpg" class="attachment-thumbnail wp-post-image" />  </a>
            </div> <!-- stacks-->
            <p class="date">Sat 15</p>
            <h1><a href="http://j3.org/2014/02/cedar-brook-3/">Cedar Brook </a></h1>
        </div> 
        <div class="albumSummary">
            <div class="stackPhoto">
                <a href="#" class="photoLink"><img width="160" height="160" src="P_Vega_de_Calardos_(160x160).jpg" class="attachment-thumbnail wp-post-image" />  </a>
